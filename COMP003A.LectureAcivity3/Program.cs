...
namespace COMP003A.LectureAcivity3
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("1. single if statment");
            ...
            if (inputNumber % 2 == 0)
            {
                //this code block executes if the condition above is true
                Console.WriteLine("\tinputNumber is even.");
            }
            else
            {
            ...
            if (inputNumber % 2 == 0)
            {
                ...
                if (inputNumber % 5 == 0)
                {
                    ...
                    Console.WriteLine("\t\tinputNumber is also divisble by 5");
                }
                else
                {
                    // this code block executes if inputNumber is
            ...
            Console.WriteLine("7. logical operator");
            Console.WriteLine($"\t{inputNumber} == {randomNumber} && {inputNumber} >= {randomNumber}: " +
